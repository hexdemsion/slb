...
function adn4_downhole_box(rop2usc, crossover) {
	...
	var ext_type = get_extender_type(1, "downhole", fin_len)
...
function digiscope_uphole_pin(rop2usc, crossover) {
	...
	var ext_type = get_extender_type(21, "uphole", fin_len)
	var ret_data = {"extender": ext_type, "fin_len": fin_len}
	return ret_data
}
...
function digiscope_downhole_box(rop2usc, crossover) {
	...
	var ext_type = get_extender_type(21, "downhole", fin_len)
	var ret_data = {"extender": ext_type, "fin_len": fin_len}
	return ret_data
}
...
function stethoscope4_uphole_pin(rop2usc, crossover) {
	...
	var ext_type = get_extender_type(22, "uphole", fin_len)
	var ret_data = {"extender": ext_type, "fin_len": fin_len}
	return ret_data
}
...
function stethoscope6_uphole_box(rop2usc, crossover) {
	...
	var ext_type = get_extender_type(23, "uphole", fin_len)
	var ret_data = {"extender": ext_type, "fin_len": fin_len}
	return ret_data
}
